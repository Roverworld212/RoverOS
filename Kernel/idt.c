...
void ld_idt(){
    //This is the code for loading the IDT
    //It outputs information about the struct sizes and what it is currently doing
    cli();
    printq("%qLoading IDT\n", QINFO);
...
//This code will be used later on to handle interrupts and exceptions
